...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attachment.object_id'
        db.alter_column('attachments_attachment', 'object_id', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Attachment.object_id'
        db.alter_column('attachments_attachment', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())
